...
# Sub Agent that is responsble for validation of Planner Agent
...
# Sub Agent for validation of Writer Agent
...
# Same logic as before but for Writer
...
# Root agent that orchestrates the whole process
root_agent = Agent(
   name="Blogger",
   model=MODEL,
